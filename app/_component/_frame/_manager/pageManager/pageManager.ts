...
export default declareComponent("page-manager", class PageManager extends Manager<PageName> {
  constructor(pageChangeCallback?: (page: string, sectiones: string[], domainLevel: number) => void, sectionChangeCallback?: (section: string) => void, widthChangeCallback?: (newWidth: number) => void) {
    ...
    ), 0, pageChangeCallback, "404", true, widthChangeCallback)
