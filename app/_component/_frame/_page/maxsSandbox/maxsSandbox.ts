...
export default declareComponent("maxs-sandbox", class extends Page {
  ...
  constructor() {
    super()
    this.svgPathElems.css({fillOpacity: 1, fill: "unset"})
    ...
    let mapOptions = {start: new Data(start), end: new Data(start + 700)}


    this.path1.anim({d: pathA, translateY, translateX}, mapOptions, guide)
