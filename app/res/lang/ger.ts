...
export default {
  "links": {
    ...
    "erwachsenenschule": "Erwachsenenschule",
  ...
  "AbteilungsShorts": {
    ...
    "Wirtschaftsingenieure": "Wirtschaftsingenieure sind echte Allrounder, da sie durch ihre fundierte technische und wirtschaftliche Ausbildung nicht nur Spezialisten sind, sondern auch Abläufe an den wesentlichen Schnittstellen im Unternehmen gestalten"
  }
}