...
export default declareComponent("biomed-page", class ElektrotechnikPage extends LazySectionedPage {
    ...
    super(new ImportanceMap<() => Promise<any>, any>(
      {
        key: new Import("", 1, (_Thumbnail: typeof Thumbnail) => {
          ...
          e.videolink("https://www.youtube.com/watch?v=DLzxrzFCyOs")
  ...
  stl() {
    return super.stl() + require("./biomedPage.css").toString()
  }
  pug() {
    return require("./biomedPage.pug").default
  }
