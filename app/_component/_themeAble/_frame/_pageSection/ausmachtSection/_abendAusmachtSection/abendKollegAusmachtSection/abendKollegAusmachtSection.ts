    ...
    constructor(baseLink: string) {
        ...
        },
        {
            text: {
                ...
                hsize: {max:60, min:40},
                content: "Zusätzlich zu der grundlegenden Ausbildung im Kolleg können sich die SchülerInnen durch Wahl einer der drei Abteilungen vertiefen. Damit können sie ihren Interessen nachgehen und werden zu Experten auf ihrem Gebiet!"
            },
            cards: [
                {
