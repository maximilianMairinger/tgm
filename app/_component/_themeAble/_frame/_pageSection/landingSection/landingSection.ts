...
export default declareComponent("landing-section", class Landing extends PageSection {
  ...
  constructor() {
    ...
    let cards = [
      ...
      new IconCard(new KunststofftechnikIcon, abt.Kunststofftechnik, lang.AbteilungsShorts.Kunststofftechnik, "https://www.tgm.ac.at/tagesschule/kunststofftechnik"),
